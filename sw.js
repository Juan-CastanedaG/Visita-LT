...
const CACHE='informe-lt-v3';
const ASSETS=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./map.js','./vendor/leaflet.js','./vendor/leaflet.css','./vendor/jszip.min.js','./vendor/shp.min.js','./vendor/pdf.min.js','./vendor/pdf.worker.min.js','./vendor/images/marker-icon.png','./vendor/images/marker-icon-2x.png','./vendor/images/marker-shadow.png','./vendor/images/layers.png','./vendor/images/layers-2x.png'];
